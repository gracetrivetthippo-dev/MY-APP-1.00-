...
- Final Batch 1 school-year narrative: 36 additional September-to-June scenes, 72 new choices, term reviews, auditions, assessments, seasonal performances, optional everyday interludes, a resolved academy mystery, two finale paths, an epilogue, spoiler-sealed locked cards, and a standalone editable `yearOneStory.ts` content file
- Seasonal academy rituals: autumn lantern evening, winter holiday letters, spring garden festival, and a June closing ceremony with branching choices and relationship consequences
