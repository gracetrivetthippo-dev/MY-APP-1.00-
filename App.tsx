...
function LocationHero({ source, title, subtitle, children }: { source:ImageSourcePropType; title:string; subtitle:string; children?:React.ReactNode }) {
  ...
  return <ImageBackground source={source} resizeMode={showWhole?'contain':'cover'} style={[styles.locationHero,styles.fullImageBackground]} imageStyle={styles.locationImage}>
...
const styles=StyleSheet.create({
  ...
  fullImageBackground:{backgroundColor:'#2E2428'},
